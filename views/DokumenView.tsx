            ...
            <CardContent className="p-4">
                <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                        <div className="p-2 bg-violet-essence rounded-lg">
                        ...
                        <div className="bg-blue-500 p-4 rounded-lg">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <p className="text-2xl font-bold text-white">
                                        {getFileSize(filteredDocuments.reduce((sum, doc) => 
                                            sum + doc.versions.reduce((vSum, version) => vSum + version.size, 0), 0
                                        ))}
                                    </p>
                                </div>
                                ...
                                <tbody>
                                    {filteredDocuments.map(doc => (
                                        <tr key={doc.id} className="border-b border-violet-essence hover:bg-violet-essence/30">
                                            ...
                                            <td className="p-3">
                                                {getFileSize(doc.versions[0]?.size || 0)}
                                            </td>
                ...
                >
                    <div className="p-6">
                        <h2 className="text-xl font-bold mb-4">
                            Riwayat Versi: {selectedDocument.name}
                        </h2>
