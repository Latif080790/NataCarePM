...
const getNotificationIcon = (type: Notification['type']) => {
    switch (type) {
        ...
        case 'task': return <CheckSquare className="w-5 h-5 text-violet-600" />;
        case 'document': return <FileText className="w-5 h-5 text-persimmon" />;
...
export default function NotificationCenterView() {
    ...
    const filteredNotifications = notifications.filter(notification => {
        const matchesType = selectedType === 'all' || notification.type === selectedType || notification.category === selectedType;
                                        ...
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-start justify-between">
                                                    <div className="flex-1">
                                                        <h4 className={`font-semibold ${!notification.isRead ? 'text-night-black' : 'text-palladium'}`}>
                                                            {notification.title}
                                                        </h4>
