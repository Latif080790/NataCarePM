...
/**
 * Legacy Audit Log Adapter
 * Maps old createAuditLog calls to createEnhancedAuditLog
 */
export const createAuditLog = async (
  ...
  return createEnhancedAuditLog(
    ...
    userRole,
    {
      ...
      // Pass changes only if they match FieldChange[], otherwise ignore or map? 
      // Enhanced expects FieldChange[], legacy might pass generic object. 
      // For now assume compatible or let TS complain if strict.
