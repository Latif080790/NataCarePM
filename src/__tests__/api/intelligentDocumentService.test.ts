...
describe('IntelligentDocumentService', () => {
  ...
  describe('CRUD Operations', () => {
    ...
    describe('Query Operations', () => {
      ...
      it('should get documents by category', async () => {
        ...
        const documents = await intelligentDocumentService.getDocumentsByCategory(
      ...
      it('should get documents by status', async () => {
        ...
        const documents = await intelligentDocumentService.getDocumentsByStatus(
  ...
  describe('Dependencies', () => {
    ...
    it('should validate dependencies', async () => {
      ...
      mockGetDoc.mockResolvedValueOnce(mockDepsSnap).mockResolvedValueOnce(mockDocSnap);
      mockSetDoc.mockResolvedValue(undefined);
