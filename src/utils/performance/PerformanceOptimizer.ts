...
export class MemoryManager {
    ...
    getMemoryStats(): MemoryStats {
        ...
        const memoryUsagePercent = memory.jsHeapSizeLimit > 0 ? 
...
export class PerformanceMonitor {
     ...
     */
    getMetricsSummary(): Record<string, { average: number; min: number; max: number; count: number }> {
...
export const systemMetricsCache = new PerformanceCache({ ttl: 60000, maxSize: 100, strategy: 'lru' });
export const userActivityCache = new PerformanceCache({ ttl: 300000, maxSize: 500, strategy: 'lru' });
export const projectMetricsCache = new PerformanceCache({ ttl: 600000, maxSize: 50, strategy: 'lru' });
