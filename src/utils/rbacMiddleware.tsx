...
export const DEFAULT_ROLE_PERMISSIONS: Record<string, Permission[]> = {
  'super-admin': [
    ...
    'view_evm', 'view_logistics', 'manage_logistics',
    ...
    'view_audit_trail', 'view_monitoring', 'manage_monitoring'
  ],
  'admin': [
    ...
    'view_users', 'manage_users',
    'view_master_data',
    'view_audit_trail', 'view_monitoring'
  ],
  'manager': [
  ...
  'viewer': [
    // Read-only access
    'view_dashboard', 'view_rab', 'view_gantt',
    'view_daily_reports', 'view_progress',
    'view_attendance', 'view_finances',
    'view_evm', 'view_logistics',
