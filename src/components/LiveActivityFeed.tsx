      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <Activity
              className={`w-5 h-5 text-violet-essence ${isRefreshing ? 'animate-spin' : ''}`}
            />
      ...
      <CardContent className="pt-0">
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1 min-w-0">
                    <p className="text-sm text-night-black">
                      ...
                      {getActionMessage(activity)}{' '}
                      <span className="font-medium text-violet-essence">
        ...
        {filteredActivity.length >= limit && (
          <div className="text-center pt-4 border-t">
            <Button variant="ghost" size="sm" onClick={() => (window.location.href = '/activity')}>
