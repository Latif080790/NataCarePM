          ...
          <div className="max-h-96 overflow-y-auto">
            {notifications.length > 0 ? (
              notifications.map((notif) => (
                <div
                  key={notif.id}
                  className={`p-3 border-b border-violet-essence/50 last:border-b-0 ${!notif.isRead ? 'bg-violet-essence/30' : 'bg-white'}`}
                >
              ...
              <p className="p-4 text-sm text-center text-palladium">
