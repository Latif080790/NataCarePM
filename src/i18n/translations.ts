export const translations = {
  ...
  id: {
    ...
    // Errors
    errors: {
      unauthorized: 'Anda tidak diizinkan mengakses sumber daya ini',
      notFound: 'Sumber daya yang diminta tidak ditemukan',
      serverError: 'Terjadi kesalahan server yang tidak terduga',
      networkError: 'Koneksi jaringan gagal',
      validationError: 'Silakan periksa input Anda dan coba lagi'
    },
