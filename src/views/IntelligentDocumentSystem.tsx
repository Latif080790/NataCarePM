...
export const IntelligentDocumentSystem: React.FC<IntelligentDocumentSystemProps> = ({ projectId }) => {
    // State management
    ...
    const getStatusIcon = (status: DocumentStatus) => {
        switch (status) {
            ...
            case 'published': return <Share className="w-4 h-4 text-purple-500" />;
                        ...
                        <div className="flex items-center space-x-2 mb-3">
                            ...
                            <span className="text-xs text-gray-600">
                                {insightsSummary.critical > 0 && (
                                    <span className="text-red-600 font-medium">{insightsSummary.critical} Critical</span>
                                )}
                                {insightsSummary.high > 0 && (
                                    <span className="text-orange-600 font-medium ml-1">{insightsSummary.high} High</span>
                                )}
                                {insightsSummary.medium > 0 && (
                                    <span className="text-yellow-600 font-medium ml-1">{insightsSummary.medium} Medium</span>
                                )}
                            </span>
                        </div>
                    )}
                        ...
                        <div className="flex items-center space-x-1 text-xs text-gray-500">
                            ...
                            {document.allVersions.length > 1 && (
                                <div className="flex items-center">
                                    ...
                                    v{document.allVersions[0]?.versionNumber}
                                </div>
                            )}
                        </div>
                    </div>
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        ...
                        <p className="text-gray-600 mt-2">
                            AI-powered document management with OCR, smart templates, digital signatures, and version control
                        </p>
                    </div>
                                ...
                                <Card key={template.id} className="cursor-pointer hover:shadow-md">
                                    <CardContent className="p-4">
                                        ...
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Button
                                                size="sm"
                                                onClick={() => handleTemplateGeneration(template.id, {})}
                                            >
                                                Generate
                                            </Button>
                                        </div>
