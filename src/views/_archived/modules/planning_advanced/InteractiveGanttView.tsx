  ...
  const ganttData = useMemo(() => {
    ...
    const scheduleTask = (task: Task): GanttTask => {
      ...
      const daysUntilDue = Math.max(
        1,
        Math.ceil((new Date(task.dueDate).getTime() - taskStart.getTime()) / (1000 * 60 * 60 * 24))
      );
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-palladium">
            Timeline proyek dengan drag & drop dan analisis critical path
          </p>
        </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold">
                  {Math.ceil(
                    (ganttData.projectEnd.getTime() - ganttData.projectStart.getTime()) /
                      (1000 * 60 * 60 * 24)
                  )}{' '}
                  days
                </p>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, showWeekends: e.target.checked }))
                  }
                  className="rounded"
                />
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, showCriticalPath: e.target.checked }))
                  }
                  className="rounded"
                />
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, showDependencies: e.target.checked }))
                  }
                  className="rounded"
                />
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, showProgress: e.target.checked }))
                  }
                  className="rounded"
                />
              ...
              <label className="flex items-center gap-2">
                <input
                  ...
                  onChange={(e) =>
                    setSettings((prev) => ({ ...prev, autoSchedule: e.target.checked }))
                  }
                  className="rounded"
                />
            ...
            <div className="min-w-[1200px]">
              ...
              <div className="divide-y">
                {filteredTasks.map((task) => {
                  ...
                  const endIndex = timelineHeaders.findIndex(
                    (h) => h.date.toDateString() === task.endDate.toDateString()
                  );
