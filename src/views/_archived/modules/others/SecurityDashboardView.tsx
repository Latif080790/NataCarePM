...
export default function SecurityDashboard() {
  ...
  const { securityConfig, securityMetrics, setSecurityConfig, validatePassword, logSecurityEvent } =
    useSecurityManager();
  const { performanceMetrics, generatePerformanceReport, performanceConfig, setPerformanceConfig } =
  ...
  const handleSecurityConfigUpdate = (updates: Partial<typeof securityConfig>) => {
    setSecurityConfig((prev: typeof securityConfig) => ({ ...prev, ...updates }));
  ...
  const handlePerformanceConfigUpdate = (updates: Partial<typeof performanceConfig>) => {
    setPerformanceConfig((prev: typeof performanceConfig) => ({ ...prev, ...updates }));
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {Object.keys(securityMetrics.activeSessions).length}
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold text-red-600">
                        {Object.values(securityMetrics.failedLoginAttempts).reduce(
                ...
                <CardContent className="p-4">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-2xl font-bold">
                        {performanceMetrics.userEngagement.activeUsers}
                      </p>
                    </div>
                    <Users className="w-8 h-8 text-green-500" />
                  </div>
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="lazyLoading" className="text-sm">
                      Enable Lazy Loading
                    </label>
                  </div>
