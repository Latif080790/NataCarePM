...
export const MonitoringView: React.FC<MonitoringViewProps> = ({ className = '' }) => {
    ...
    const { analytics, loading: analyticsLoading, refresh: refreshAnalytics } = useDashboardAnalytics(timeRange);
            ...
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-gray-600">
                        Real-time monitoring and analytics for NataCarePM
                    </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-lg border">
                        <div className={`w-3 h-3 rounded-full ${getHealthStatusColor()} ${health?.status === 'healthy' ? 'animate-pulse' : ''}`} />
                    ...
                    >
                        <span className={healthLoading || analyticsLoading ? 'animate-spin' : ''}>
                            🔄
                        </span>
                        Refresh
                    </Button>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <select className="w-full p-2 border rounded-lg">
                                    ...
                                    <option value="10" selected>10 errors/min</option>
