                ...
                <div className="flex items-center gap-4">
                    <div>
                        ...
                        <p className="text-palladium flex items-center gap-2">
                            ...
                            {autoRefresh && (
                                <span className="text-green-600 text-xs">• Auto refresh aktif</span>
                            )}
                        </p>
                    </div>
                                            ...
                                            <div key={index} className="flex items-center gap-4">
                                                ...
                                                <div className="flex-1">
                                                    <div className="flex justify-between items-center">
                                                        ...
                                                        <span className="text-xs text-palladium">{formatDate(report.date)}</span>
                                                    </div>
                                                    <Progress 
                                                        value={Math.min(100, 20 + (index * 15))} 
                                                        className="mt-1" 
                                                    />
                                                </div>
                                            </div>
                            ...
                            <Card>
                                ...
                                <CardContent>
                                    <div className="space-y-3">
                                        {filteredMetrics.filteredNotifications?.slice(0, 5).map((notification, index) => (
