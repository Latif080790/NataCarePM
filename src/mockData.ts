...
export const MOCK_USERS: User[] = [
  {
    ...
    roleId: 'pm',
    avatarUrl: getAvatarUrlSync('a042581f4e29026704d', 'John Doe'),
    isOnline: true,
  ...
  },
  {
    ...
    roleId: 'admin',
    avatarUrl: getAvatarUrlSync('a042581f4e29026704e', 'Jane Smith'),
    isOnline: true,
    lastSeen: new Date().toISOString(),
  },
  {
    ...
    roleId: 'site_manager',
    avatarUrl: getAvatarUrlSync('a042581f4e29026704f', 'Bob Johnson'),
    isOnline: false,
  ...
  },
  {
    ...
    roleId: 'finance',
    avatarUrl: getAvatarUrlSync('a042581f4e29026705a', 'Alice Williams'),
    isOnline: true,
    lastSeen: new Date().toISOString(),
  },
];
...
const MOCK_AUDIT_LOG_1: AuditLog[] = [
  {
    ...
    userId: 'user3',
    userName: 'Bambang Lapangan',
    action: 'Membuat laporan harian baru.',
  },
  {
    id: 'al2',
    timestamp: addDays(today, -2).toISOString(),
    userId: 'user1',
    userName: 'Jevline Kief',
    action: 'Menyetujui Purchase Order PR-12346.',
  },
  {
    id: 'al3',
    ...
    action: 'Mencatat pengeluaran baru: Sewa Molen.',
  },
];
...
export const MOCK_DB: {
      ...
      projects: [
        {
          ...
          dailyReports: [
            {
              ...
              weather: 'Cerah',
              notes: 'Galian pondasi selesai sepenuhnya.',
              workforce: [{ workerId: 'W001', workerName: 'Budi S.' }],
              workProgress: [{ rabItemId: 2, completedVolume: 30 }],
              materialsConsumed: [],
              photos: [],
              comments: [],
            },
            {
              ...
              weather: 'Cerah',
              notes: 'Galian pondasi selesai.',
              workforce: [{ workerId: 'W001', workerName: 'Budi S.' }],
              workProgress: [{ rabItemId: 2, completedVolume: 20 }],
              materialsConsumed: [],
              photos: [],
              comments: [],
            },
            {
              ...
              weather: 'Hujan',
              notes:
                'Pekerjaan beton sloof berjalan lancar, namun sedikit terhambat hujan di sore hari.',
              ...
              comments: [
                {
                  id: 'c1',
                  authorId: 'user1',
                  authorName: 'Jevline Kief',
                  authorAvatar: MOCK_USERS[0].avatarUrl,
                  content:
                    'Pastikan kualitas beton tetap terjaga ya, Pak Bambang. Hujan bisa berpengaruh.',
                  timestamp: addDays(today, -7).toISOString(),
                },
                {
                  id: 'c2',
                  authorId: 'user3',
                  authorName: 'Bambang Lapangan',
                  authorAvatar: MOCK_USERS[2].avatarUrl,
                  content: 'Siap, Bu. Sudah kami antisipasi dengan terpal.',
                  timestamp: addDays(today, -7).toISOString(),
                },
              ],
            },
          ...
          attendances: [
            { date: todayStr, workerId: 'W001', status: 'Hadir' },
            { date: todayStr, workerId: 'T001', status: 'Hadir' },
            { date: todayStr, workerId: 'M001', status: 'Hadir' },
            { date: todayStr, workerId: 'W002', status: 'Sakit' },
            {
          ...
          expenses: [
            {
              id: 'ex1',
              description: 'Pembelian Semen 50 sak (Stok awal)',
              amount: 3500000,
          ...
          documents: [
            {
              id: 'doc1',
              name: 'Kontrak_Kerja.pdf',
              category: 'Legal',
              uploadDate: addDays(today, -40).toISOString().split('T')[0],
              url: '#',
            },
            {
              id: 'doc2',
              name: 'Gambar_Denah_Lantai_1.dwg',
              category: 'Teknis',
              uploadDate: addDays(today, -35).toISOString().split('T')[0],
              url: '#',
            },
          ],
          purchaseOrders: [
            {
              ...
              requester: 'Bambang Lapangan',
              requestDate: addDays(today, -5).toISOString().split('T')[0],
            },
            {
              id: 'po2',
              prNumber: 'PR-12346',
              ...
              requester: 'Bambang Lapangan',
              requestDate: addDays(today, -12).toISOString().split('T')[0],
              approver: 'Jevline Kief',
            },
          ],
          inventory: [
            { materialName: 'Semen PC', quantity: 100, unit: 'sak' },
            { materialName: 'Pasir Pasang', quantity: 10, unit: 'm3' },
            { materialName: 'Batu Bata', quantity: 5000, unit: 'bh' },
          ],
          termins: [
            {
              id: 'T1',
              ...
              percentage: 20,
              amount: 85750000 * 0.2,
              date: addDays(today, -28).toISOString().split('T')[0],
              status: 'Dibayar',
            },
            {
              id: 'T2',
              description: 'Progres 30%',
              percentage: 30,
              amount: 85750000 * 0.3,
        ...
        },
        {
          ...
          items: [
            {
              id: 1,
              no: 'A.1',
              uraian: 'Pembongkaran Dinding Eksisting',
              volume: 50,
              satuan: 'm2',
              hargaSatuan: 50000,
              kategori: 'Persiapan',
          ...
          expenses: [
            {
              id: 'ex-b1',
              description: 'Uang muka vendor renovasi',
              amount: 10000000,
          ...
          auditLog: [
            {
              id: 'al-b1',
              timestamp: addDays(today, -9).toISOString(),
              userId: 'user4',
              userName: 'Siti Keuangan',
              action: 'Mencatat pengeluaran: Uang muka vendor.',
            },
          ],
        },
      ],
  ...
  notifications: [
    {
      id: 'n1',
      message: 'Purchase Order PR-12345 membutuhkan persetujuan Anda.',
      isRead: false,
      timestamp: addDays(today, -2).toISOString(),
      linkTo: 'logistik',
    },
    {
      id: 'n2',
      message: 'Laporan harian untuk kemarin telah ditambahkan oleh Bambang.',
      isRead: false,
      timestamp: addDays(today, -1).toISOString(),
      linkTo: 'laporan_harian',
    },
    {
      id: 'n3',
      message: 'Pembayaran termin T2 telah dikonfirmasi.',
      isRead: true,
