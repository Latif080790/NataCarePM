            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                {criticalAlerts.slice(0, 2).map((alert) => (
                  <p key={alert.id} className="text-sm text-red-800 dark:text-red-300">
                    • {alert.title}
                  </p>
                ))}
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
          {dashboardData.kpis.map((kpi) => {
            ...
            return (
              <div
                key={kpi.id}
                className={`bg-white dark:bg-gray-800 rounded-lg border-2 ${getStatusColor(kpi.status)} p-4`}
              >
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
                  {dashboardData.portfolio.activeProjects}
                </div>
                <div className="text-sm text-gray-600 dark:text-gray-400">Active</div>
              </div>
              <div>
                <div className="text-2xl font-bold text-green-600 dark:text-green-400">
                  {dashboardData.portfolio.completedProjects}
                </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span
                  className={`font-semibold ${dashboardData.financial.variance >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'}`}
                >
                  {dashboardData.financial.variance >= 0 ? '+' : ''}$
                  {(dashboardData.financial.variance / 1000000).toFixed(2)}M
                </span>
              </div>
            </div>
          </div>
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col gap-2">
                        <button
                          ...
                          className="text-xs px-3 py-1 bg-white dark:bg-gray-800 border border-current rounded"
                        >
                          Acknowledge
                        </button>
                        <button
