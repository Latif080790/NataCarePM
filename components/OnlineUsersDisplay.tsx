...
export default function OnlineUsersDisplay({ showActivity = true, compact = false }: OnlineUsersDisplayProps) {
    const { 
        onlineUsers, 
        currentUserPresence, 
        recentActivity, 
                            ...
                            <div>
                                ...
                                <div className="space-y-2">
                                    {recentUsers.map((user) => (
                                        <div key={user.id} className="flex items-center justify-between p-2 rounded-lg hover:bg-gray-50 opacity-70">
                                            <div className="flex items-center gap-3">
                                                <div className="relative">
                                                    <div 
                                                        className="w-10 h-10 rounded-full text-white flex items-center justify-center text-sm font-semibold"
                        ...
                        {Object.keys(typingUsers).length > 0 && (
                            <div className="border-t pt-3">
                                <div className="flex items-center gap-2 text-sm text-blue-600">
                                    ...
                                    <span>
                                        {Object.values(typingUsers).map(user => user.displayName).join(', ')} sedang mengetik...
                                    </span>
                                </div>
                            </div>
                        )}
