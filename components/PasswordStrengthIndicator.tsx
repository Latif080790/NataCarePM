...
import { validatePassword, getPasswordStrengthColor, estimateCrackTime, type PasswordStrength } from '../utils/passwordValidator';
    ...
    <div style={{ marginTop: '12px', marginBottom: '8px' }}>
      ...
      <div style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4px' }}>
          ...
          <RequirementItem met={/[!@#$%^&*()_+\-=\[\]{};':"\\|,.<>\/?`~]/.test(password)} label="Special character" />
