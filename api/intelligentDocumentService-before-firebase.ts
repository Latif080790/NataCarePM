...
export class IntelligentDocumentService {
    ...
    async createDocument(
        ...
        try {
            ...
            if (!validators.isValidString(description, 0, 2000).valid) {
                throw new APIError(ErrorCodes.INVALID_INPUT, 'Invalid description', 400);
            }
            ...
            if (!validators.isValidId(createdBy)) {
                throw new APIError(ErrorCodes.INVALID_INPUT, 'Invalid creator ID', 400, { createdBy });
            }
    ...
    // Process document with AI-powered features (with comprehensive error handling)
    ...
    // Get documents by project with validation
